...
## I. 3계층 아키텍처: Channel -> Gateway -> Node

먼저 전체 그림을 봅시다:

![OpenClaw 아키텍처](/images/openclaw-architecture-ko.svg)

OpenClaw을 세 개의 부서를 가진 회사라고 생각해 보세요:
...
## III. Channel 어댑터 계층: 한 번 만들고 어디서든 대화
...
## V. 4단계 메모리: AI가 정말로 당신을 기억하게 만들기
...
## VII. Multi-Agent 라우팅: 하나의 두뇌, 여러 인격
