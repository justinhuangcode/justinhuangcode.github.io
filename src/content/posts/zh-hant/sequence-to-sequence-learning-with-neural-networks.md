...
2014 年 9 月 10 日，三個 Google 研究員在 arXiv（一個學術論文預印本網站，論文不用等期刊審稿就能直接發布）上傳了一篇論文：<a href="/papers/1409.3215v3.pdf" target="_blank">《Sequence to Sequence Learning with Neural Networks》</a>（使用神經網路進行序列到序列學習）。
